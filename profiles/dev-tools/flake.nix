{
  ...
  inputs = {
    ...
    goreleaser-flake.url = "github:Sackbuoy/flakes?dir=go/goreleaser";
    golangci-flake.url = "github:Sackbuoy/flakes?dir=go/golangci-lint";
  };
      ...
      system: let
        ...
        go-dev-tools = pkgs.symlinkJoin {
          ...
          paths = [
            ...
            # pkgs.golangci-lint
            goreleaser-flake.packages.${system}.default
            golangci-flake.packages.${system}.v-2-3-1
            # goreleaser-pinned-pkgs.gci
            pkgs.gotools
            pkgs.gotestsum
          ];
          postBuild = ''
        ...
        kube-dev = pkgs.symlinkJoin {
          ...
          paths = with pkgs; [
            kubectl
            kubectx
            # docker # using podman alias for docker
            kubernetes-helm
            argocd
            rancher
            stern
